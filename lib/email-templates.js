      ...
      return {
        ...
        htmlBody: buildPersonalHumanEmail({
          bodyContent: `
            ...
            <p style="font-size: 13.5px; color: #475569; margin: 10px 0;">
              <em>(Note: You can apply code <strong>welcome25</strong> for 25% off on www.MetaPilot.in if you decide to upgrade).</em>
            </p>
            <p style="margin: 14px 0; font-size: 13px; color: #475569;">
              📺 <strong>Want to see it in action?</strong> Check out our YouTube channel <strong>@MetaPilotApps</strong> (<a href="https://www.youtube.com/@MetaPilotApps" style="color: #2563eb; text-decoration: underline;">watch video demos</a>) or follow on Instagram <a href="https://www.instagram.com/metapilot_go_pro/" style="color: #2563eb; text-decoration: underline;">@metapilot_go_pro</a> and drop a comment!
            </p>
