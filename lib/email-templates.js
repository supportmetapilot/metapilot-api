...
export function getMailTemplate(templateCode, data) {
  ...
  switch (code) {
        ...
        htmlBody: buildPersonalHumanEmail({
          bodyContent: `
            ...
            <p style="margin: 16px 0;">
              👉 <a href="${WEBSITE_URL}" style="color: #2563eb; font-weight: bold; text-decoration: underline; font-size: 15px;">www.MetaPilot.in</a>
            </p>
            <p style="font-size: 13.5px; color: #475569; margin: 10px 0;">
              <em>(Note: If you decide to upgrade to any plan, you can use code <strong>welcome25</strong> for 25% off on www.MetaPilot.in)</em>
            </p>
            <p style="margin: 14px 0; font-size: 13px; color: #475569;">
              📺 <strong>Want to see it in action?</strong> Search <strong>@MetaPilotApps</strong> on YouTube (<a href="https://www.youtube.com/@MetaPilotApps" style="color: #2563eb; text-decoration: underline;">watch demo videos</a>) or find us on Instagram at <a href="https://www.instagram.com/metapilot_go_pro/" style="color: #2563eb; text-decoration: underline;">@metapilot_go_pro</a> and drop your questions in the comments!
            </p>
            ...
            <p style="margin-top: 24px;">
              ...
              <span style="color: #64748b; font-size: 13px;">MetaPilot &bull; India</span><br>
              <a href="${WEBSITE_URL}" style="color: #2563eb; font-size: 13px;">www.MetaPilot.in</a>
            </p>
          `,
        }),
      };
      ...
      return {
        ...
        htmlBody: buildPersonalHumanEmail({
          bodyContent: `
            ...
            <p style="font-size: 13.5px; color: #475569; margin: 10px 0;">
              <em>(Note: You can use coupon code <strong>welcome25</strong> for 25% off on www.MetaPilot.in).</em>
            </p>
            <p style="margin: 14px 0; font-size: 13px; color: #475569;">
              📺 <strong>Want to see real demos?</strong> Search <strong>@MetaPilotApps</strong> on YouTube (<a href="https://www.youtube.com/@MetaPilotApps" style="color: #2563eb; text-decoration: underline;">watch walkthrough videos</a>) or check our Instagram <a href="https://www.instagram.com/metapilot_go_pro/" style="color: #2563eb; text-decoration: underline;">@metapilot_go_pro</a> and drop any questions in the comments!
            </p>
    ...
    case "F":
      return {
        subject: `Quick note on your ${role} interview preparation, ${name}`,
        htmlBody: buildPersonalHumanEmail({
          bodyContent: `
            <p>Hi ${name},</p>
            <p>I came across your profile and noticed you are preparing for upcoming opportunities in the <strong>${role}</strong> domain.</p>
            <p>One of the biggest hurdles candidates face in technical interviews is structuring answers properly under pressure, even when they know the core technical concepts well.</p>
            <p>To help you speak fluently and handle difficult rounds with ease, we built <strong>MetaPilot</strong> — an invisible desktop AI co-pilot that assists you silently in real time:</p>
            <ul style="padding-left: 18px; line-height: 1.75; color: #2d3748;">
              <li><strong>Instant Answer Pointers:</strong> Generates crisp, structured bullet points as the interviewer speaks so you sound clear, confident, and senior-level.</li>
              <li><strong>Live Problem Solving:</strong> Press Ctrl+Z to take a silent snapshot of any coding problem, SQL query, or error on screen for instant hints.</li>
              <li><strong>100% Invisible:</strong> Runs privately on your desktop and never shows up during screen sharing on Google Meet, Zoom, or Teams.</li>
            </ul>
            <p style="margin-top: 14px; margin-bottom: 6px; color: #334155;">
              <strong>Career Guidance &amp; Mentor Support:</strong><br>
            ...
            <p>You can test the <strong>1-day free trial</strong> directly on your laptop before any upcoming rounds:</p>
            <p style="margin: 16px 0;">
              👉 <a href="${WEBSITE_URL}" style="color: #2563eb; font-weight: bold; text-decoration: underline; font-size: 15px;">www.MetaPilot.in</a>
            </p>
            <p style="font-size: 13.5px; color: #475569; margin: 10px 0;">
            ...
            <p>If you'd like us to set up your test access directly, feel free to <strong>reply "YES" to this email</strong> and we'll send your login details right away.</p>
            <p style="margin-top: 24px;">
              Best regards,<br>
              <strong>Team MetaPilot</strong><br>
              <span style="color: #64748b; font-size: 13px;">MetaPilot &bull; India</span><br>
